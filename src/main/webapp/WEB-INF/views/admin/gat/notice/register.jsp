...
<script>
    ...
    $("#autofill").on("click", function () {
		...
		editor.setData(`
                        <h2>기쁜 소식을 전달해 드립니다🎉</h2>
                        <h2>10월 21일 토요일에 인사팀 신짱구 사원이 한 신부의 신랑이 됩니다.</h2>
                        <h2>새 출발을 하는 신짱구 사원의 앞으로의 모든 나날에 사랑이 깃들도록</h2>
                        <h2>함께 축복해 주시길 바랍니다!</h2>
                        <h2>자세한 시간과 장소는 첨부한 파일을 참고해 주세요🙌</h2>
                        `);
    })
    let maxNum;
